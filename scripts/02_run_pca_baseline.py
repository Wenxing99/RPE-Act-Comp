...
from experiments.build_bases import build_pca_bases
...
def main() -> None:
    ...
    bases = build_pca_bases(bundle, layer_index=layer_index, rank=rank)
    ...
    save_json(
        ...
        artifact_root / "pca_summary.json",
    )
